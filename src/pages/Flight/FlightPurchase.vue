  ...
  <div class="before-purchase">
    ...
    <div class="before-purchase__bottom">
      <div class="before-purchase__price-block">
        <h3 class="before-purchase__price ">$ 157</h3>
...
.route-center {
  ...
  position: relative;
  background: linear-gradient(90deg, #e6e6e6 0%, #e6e6e6 50%, #ffffff 50%, #ffffff 100%);
